...
**Язык интерфейса:** весь пользовательский UI портала NOCKO MDM (включая раздел Enrollment / генерацию пакетов, навигацию, формы, уведомления и ошибки) — **на английском языке** (en-US), если иное не оговорено отдельным продуктовым требованием. Дополнительные локали — вне scope данного ТЗ, если не указано иначе.
